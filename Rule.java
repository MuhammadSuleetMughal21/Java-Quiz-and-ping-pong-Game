...
public class Rule extends JFrame implements ActionListener{
	...
	Rule(){
			...
			setVisible(true);
			 ...
			 JLabel l1 = new JLabel("Instructions for Quiz");
             ...
             l2.setText(
            		 "<html>"+
            				 ...
            				 "2. Basic awareness of JAVA will help you to accomplish this quiz" + "<br><br>"+
            				 "3. Question will skip to the next after every 10 seconds" + "<br><br>"+
            				 "4. 3 Levels will be part of this game" + "<br><br>"+
            				 "____________________GOODLUCK!!!_______________"+"<br><br>"+
            	"<html>"
            		 );
             add(l2);
             ImageIcon background_image = new ImageIcon("C:\\Users\\USER\\eclipse-workspace\\Quiz game\\src\\icons\\game.jpg");
